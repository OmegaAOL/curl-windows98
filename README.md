...
**NOTE: YOU NEED TO LINK TO THE CERTIFICATE FILE https://curl.se/ca/cacert.pem IN AUTOEXEC.BAT ENVIRONMENT VARIABLES, TEMPORARY ENVIRONMENT VARIABLES, OR BY RUNNING COMMANDS WITH THE FLAG AND PATH "curl --cacert C:\your\path\here\cacert.pem https://example.com".
